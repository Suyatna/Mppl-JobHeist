...
public class ListPostPekerjaanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_post_pekerjaan);
        ...
        getSupportActionBar().setTitle("List Post Pekerjaan");

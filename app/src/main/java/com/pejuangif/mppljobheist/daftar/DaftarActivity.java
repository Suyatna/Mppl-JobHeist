...
public class DaftarActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btn_pkerja = findViewById(R.id.btn_daftar_pencarikerja);
        btn_pmberikerja = findViewById(R.id.btn_daftar_pemberikerja);
    ...
    protected void onStart() {
        ...
        btn_pkerja.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent= new Intent(DaftarActivity.this, RegisterPekerjaActivity.class);
        ...
        btn_pmberikerja.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent= new Intent(DaftarActivity.this, RegisterPemberiKerjaActivity.class);
                startActivity(intent);
            }
        });
    }
